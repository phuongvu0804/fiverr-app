            ...
            <div className="gig__img gig__img--no-gig">
                <svg width="252" height="104" viewBox="0 0 252 104" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path
                        ...
                        strokeMiterlimit="10"
                    ></path>
                    <path d="M98.027 66.0029H182.398" stroke="#222325" strokeWidth="1.5" strokeMiterlimit="10"></path>
                    <path
                    ...
                    <path
                        ...
                        strokeMiterlimit="10"
                    ></path>
                    <path d="M52.2679 59.8315V74.4419" stroke="#222325" strokeWidth="1.5" strokeMiterlimit="10"></path>
                    <path d="M59.1 59.8315V74.4419" stroke="#222325" strokeWidth="1.5" strokeMiterlimit="10"></path>
                    <path
                        ...
                        strokeMiterlimit="10"
                    ></path>
                    <path d="M22.749 55.1992H69.831" stroke="#222325" strokeWidth="1.5" strokeMiterlimit="10"></path>
                    <path
                    ...
                    <path
                        ...
                        strokeMiterlimit="10"
                    ></path>
                    <path d="M125.558 77.8633H150.289" stroke="#222325" strokeWidth="1.5" strokeMiterlimit="10"></path>
                    <path d="M124.606 83.2725H141.763" stroke="#222325" strokeWidth="1.5" strokeMiterlimit="10"></path>
                    <path
